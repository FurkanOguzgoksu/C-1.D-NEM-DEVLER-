//Klavyeden girilen 50 sayýlýk bir dizinin sayýlarýn tamamýný,toplamýný,ortalamasýný,
//ortalamadan büyük sayý adedini,ortalamadan küçük sayý adedini,ortalamaya eþit sayý adedini veren koddur.
...
// Büyük ve küçük sayýlarý kontrol etme
	for(i=0;i<50;i++)
	{
		if(ort<dizi[i])
		{	b_sayac++;	}
